...
public:
	...
	size_t GetSize() const { pxFail("not impl"); return 0;/* m_emitter.GetSizeOfCodeGenerated(); */}
	const u8* GetCode() const { pxFail("not impl"); return 0;/*return m_emitter.GetBuffer().GetStartAddress<const u8*>();*/ }
